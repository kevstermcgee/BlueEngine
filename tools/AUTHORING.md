...
GameDocument v1 adds a separate, bounded rules layer: use native `be2-tools game-describe`, `game-schema`, `game-example NEW_DIRECTORY` and `game-validate GAME.json`. See [game quickstart](../docs/GAME_QUICKSTART.md). Map v1 remains geometry-only.
